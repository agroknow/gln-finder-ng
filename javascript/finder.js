                                       ...
                                       if (item.format.indexOf('pdf') != -1)
                                        ...
                                        item.format='./icons/ppt.png';
                                           ...
                                           item.format='./icons/application.png';
                                                ...
                                                $('search_results').insert(Jaml.render('naked',item));
...
//    -----
                         Jaml.register('naked', function(data){
                                        article({cls:'item-intro odd'},
                                                              header(a({href:data.location, title: data.title,  target: '_blank'}, data.title)
                                                                      ),
                                                              section(
                                                                      p({cls:'item_intro_desc'}, data.description),
                                                                      aside({cls:'clearfix'},
                                                                            div({cls:'floatleft'},
                                                                                div({cls:'line'},
                                                                                 span("typical age context:"), a({cls:'secondary'},"16-U")),
                                                                                div({cls:'line keyword'},
                                                                                    span("Keywords:"),
                                                                                    a({href:data.location, cls:'secondary'},"Keyword1"),
                                                                                    a({href:data.location, cls:'secondary'},"Keyword2")),
                                                                                div({cls:'line'},
                                                                                    span("Collection: "),
                                                                                    a({href:data.location, cls:'secondary'}),
                                                                                    span("Provider: "),
                                                                                    a({href:data.location, cls:'secondary'}))
                                                                                ),
                                       
                                                                            div({cls:'floatright'},
                                                                                div({cls:'line alignright'}, a({href:"http:\\www.apple.com", cls:'moreinfo'}, "More Info")))
                                                                            )
                                                                      )
